...
public class Inicio {
    ...
    private void initialize() {
        ...
        lblNewLabel_2 = new JLabel("<html>En Travel Discover, no solo creamos rese�as; creamos conexiones entre los viajeros y los lugares que desean explorar. Nuestra misi�n es llevar a los viajeros m�s all� de las postales y las descripciones superficiales, sumergi�ndolos en la autenticidad de cada lugar. Ya sea que est�s planeando unas vacaciones en familia, una escapada rom�ntica o una aventura en solitario, nuestras rese�as est�n dise�adas para inspirar y brindarte una visi�n realista de lo que te espera.</html>");
        ...
        JLabel lblNewLabel_10_1 = new JLabel("<html>Sum�rgete en la magia de Grecia: templos ancestrales, playas paradis�acas y la huella de los dioses te esperan. Explora su historia, disfruta de la belleza de las islas y d�jate cautivar por su cultura legendaria.</html>");
